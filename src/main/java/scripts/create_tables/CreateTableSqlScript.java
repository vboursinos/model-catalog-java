...
public class CreateTableSqlScript {
  ...
  private String getSqlScript() {
    return "-- Create an extension if not already enabled to generate UUIDs\n"
        ...
        + "  id uuid DEFAULT generate_uuid() PRIMARY KEY,\n"
        + "  categorical_parameter_id uuid REFERENCES categorical_parameter (id) NOT NULL,\n"
        ...
        + "  id uuid DEFAULT generate_uuid() PRIMARY KEY,\n"
        + "  integer_parameter_id uuid REFERENCES integer_parameter (id) NOT NULL,\n"
        ...
        + "  id uuid DEFAULT generate_uuid() PRIMARY KEY,\n"
        + "  float_parameter_id uuid REFERENCES float_parameter (id) NOT NULL,\n"
